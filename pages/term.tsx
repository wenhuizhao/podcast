  ...
  <div className="min-h-screen bg-gradient-to-br from-gray-100 to-white min-h-screen flex flex-col items-strech">
    ...
    <main className="flex flex-grow flex-col container mx-auto p-2 flex flex-col items-center">
      <p>
        ...
        carefully before using NotebookVideo.com website (the “service”).
      </p>
      ...
      <p>
        ...
        policy
        <Link href="/privacy"> link</Link> regarding our user data collection.
        It will help you better understand our practices.
      </p>
      <h3>Copyright</h3>
      <p>
        Content published on this website (digital downloads, images, texts,
        graphics, logos) is the property of the website owner and/or its content
        ...
        property of website owner, with copyright authorship for this
        compilation by website owner.
      </p>
      ...
      <p>
        By visiting this website, you agree that the laws of the United States,
        without regard to principles of conflict laws, will govern these terms
        of service, or any dispute of any sort that might come between webiste
        owner and you, or its business partners and associates.
      </p>
      <h3>Disputes</h3>
      <p>
        ...
        court in United States and you consent to exclusive jurisdiction and
      ...
      <p>
        ...
        such content. When you post your content, you grant website owner
