...
su - ubuntu -c "DB_PASSWORD=$DB_USER_PASSWORD AWS_SECRET_ACCESS_KEY=$S3_AWS_ACCESS_KEY python3 /home/ubuntu/process_job.py {script_param} &> out"
#sudo DB_PASSWORD="$DB_USER_PASSWORD" AWS_SECRET_ACCESS_KEY="$S3_AWS_ACCESS_KEY" -u ubuntu python3 /home/ubuntu/process_job.py "{script_param}"
"""
